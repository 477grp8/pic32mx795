 ...
 */
void TurnOffLexmarkLED() {
    mPORTDClearBits(BIT_10);              //Turn off the bit

    mPORTDSetPinsDigitalIn( BIT_10 );    //Ensures the pin is in GPIO mode
...
void drawLightDetectedBar() {
    ...
    int currentLightLevelBars = getChannel4Value() / (1023 / NUMBER_OF_BARS);
